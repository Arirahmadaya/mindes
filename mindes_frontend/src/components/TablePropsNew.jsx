...
function TablePropsNew({
  ...
  const [sortDescriptor, setSortDescriptor] = React.useState({
    column: "judul", // Ubah ke "judul" karena ini sesuai dengan properti yang Anda gunakan
    direction: "ascending",
  });
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (filterValue) {
      filteredIsi = filteredIsi.filter((user) =>
        user[sortDescriptor.column].toLowerCase().includes(filterValue.toLowerCase())
      );
    }
    ...
    return filteredIsi;
  }, [filterValue, statusFilter, isi, sortDescriptor.column]);
  ...
  const handlePrint = (user) => {
    // Implementasi logika cetak di sini
    console.log("Print item:", user);
  };
