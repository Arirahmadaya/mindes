...
import { ArrowDownCircleIcon, ArrowTopRightOnSquareIcon } from "@heroicons/react/20/solid";
          ...
          <NavbarContent as="div" className="items-center" justify="center">
            ...
            <Dropdown placement="bottom-end">
              ...
              <DropdownMenu aria-label="Profile Actions" variant="flat">
                ...
                {profile.roles && (profile.roles.includes("admin") || profile.roles.includes("superadmin")) && (
              <DropdownItem
                as={Link}
                href="/admin/beranda"
              >
              <span><ArrowTopRightOnSquareIcon  className="w-5 h-5" /></span>
              </DropdownItem>
            )}
                <DropdownItem
                  key="user-profile"
          ...
          <NavbarMenuItem key={index}>
            <Link
              ...
              className={`w-full flex items-center py-2 px-4 ${
                isActive(item.href) ? "text-primary-30" : ""
              }`}
              href={item.href}
              size="lg"
            >
