    ...
    <div className="bg-white">
      ...
      <main className="">
        ...
        <div className="mt-20 text-center lg:text-left ">
          ...
          <section className="mt-20 bg-blue-900 text-white lg:p-12 py-6 px-4 rounded-lg">
            <div className="text-center">
              ...
              <div className="flex justify-evenly items-center mt-6 space-x-4">
                <div className="flex flex-col items-center">
                  ...
                  />
                  <div className="text-center lg:text-caption-1 md:text-caption-2 text-[10px] font-normal lg:leading-[28.80px]">
                    Kalinyamat Kulon
                    <br />
                    Kota Tegal
                  </div>
          ...
          <section className="">
            <div className="flex items-center justify-between">
              <div className="w-1/2 text-center lg:p-16">
                <div className=" lg:text-display-2 text-heading-6 font-bold lg:leading-[64.80px] leading-[25.80px] lg:-mt-36 lg:mb-8 mb-2">
                  Build Your Own Village Website
                </div>
                <div className=" lg:text-heading-6 text-justify text-caption-2 font-normal lg:leading-[28.80px] px-2">
    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
          ...
          <Typography variant="h5" className="mb-6">
            <div className="flex">
              <img
                ...
                alt="logo"
                className="md:w-auto md:h-20  pr-2 w-auto h-16 "
              />
              <div className="text-[#BBDEFB] hover:text-blue/80 text-left font-bold lg:text-heading-3 text-heading-5 lg:-mt-1 ">
                <p>ADILOG</p>
                <p>INDES</p>
              </div>
            </div>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="/about/mindes">Madilog Team </a> Semua
            hak dilindungi.
          </Typography>
