     ...
     <NavbarMINDes />
      <main className="container mx-auto px-6 py-12">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">MINDes sebuah platform yang memungkinkan masyarakat desa menerima informasi dan mampu berpartisipasi aktif dalam pembangunan desa dengan pengelolaan dana desa yang efisien, transparan, dan responsif yang dilakukan oleh pemerintah desa, demi mewujudkan desa yang lebih sejahtera dan maju.</p>
          <div className="mt-6">
        ...
        <section className="mt-12">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-800">Join 100+ Villages that are already growing with us</h2>
        ...
        <section className="mt-12 bg-white p-6 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-bold text-gray-800">Build Your Own Village Website</h2>
              <p className="mt-4 text-gray-600">You can organise what you want to display on your website with guaranteed data security. You can also add cloud storage or form that is still made manually in your village.</p>
            </div>
            <div className="md:w-1/2 flex justify-center mt-6 md:mt-0">
              <img src="/village-website.png" alt="Village Website" className="max-w-full h-auto" />
            </div>
          </div>
        </section>
        ...
        <section className="mt-12 bg-blue-500 text-white p-6 rounded-lg shadow-md">
          <div className="text-center">
            ...
            <p className="mt-4">We'd love to hear from you. Please fill out the form below or email us directly at mindes@gmail.com</p>
          </div>
