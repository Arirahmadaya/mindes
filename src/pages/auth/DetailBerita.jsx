...
const DetailBerita = () => {
  return (
    <div>
      <NavbarUser />
      <div className="flex justify-between mx-auto max-w-6xl p-4 flex-col md:flex-row">
        <div className="md:w-2/3">
          <article className="bg-white p-6 rounded-lg shadow-md mb-8">
            <div className="text-neutral-900 text-base font-semibold font-['Open Sans'] leading-[13px] tracking-tight mb-2">
              / Berita Desa
            </div>
            <div className="text-black text-[30px] font-bold font-['Open Sans'] leading-[40px]">Monitoring posyandu melati 2<br/>desa kalinyamat kulon </div>
            <div className="flex items-center text-gray-600 text-sm mb-2">
            <div className="text-black/caption-2 text-xs font-light font-['Open Sans']">5 Mei 2024, 16:53 WIB - 3 Hari yang lalu</div>
            </div>
            ...
            <div className="text-black text-xs font-light font-['Open Sans'] text-center mb-4">
        ...
        <aside className="md:w-1/3 md:ml-4">
          <RelatedNews />
        </aside>
      </div>
      <Footer />
