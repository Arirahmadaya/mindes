  ...
  "node_modules/@ckeditor/ckeditor5-react/dist/index.js"(exports2, module2) {
    !function(t, e) {
      ...
      a.n = (t2) => {
        ...
        for (var o2 in e2)
          a.o(e2, o2) && !a.o(t2, o2) && Object.defineProperty(t2, o2, { enumerable: true, get: e2[o2] });
      }, a.o = (t2, e2) => Object.prototype.hasOwnProperty.call(t2, e2), a.r = (t2) => {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t2, "__esModule", { value: true });
      };
      var i = {};
      return (() => {
        a.r(i), a.d(i, { CKEditor: () => h, CKEditorContext: () => d, useMultiRootEditor: () => C });
        var t2 = a(155), e2 = a.n(t2), o2 = a(949), r2 = a.n(o2);
        const n2 = new Array(256).fill("").map((t3, e3) => ("0" + e3.toString(16)).slice(-2));
        var s = a(546);
        const c = e2().createContext("contextWatchdog");
        class d extends e2().Component {
          constructor(t3, e3) {
          ...
          render() {
            return e2().createElement(c.Provider, { value: this.contextWatchdog }, this.props.children);
          }
        ...
        d.defaultProps = { isLayoutReady: true, onError: (t3, e3) => console.error(t3, e3) }, d.propTypes = { id: r2().string, isLayoutReady: r2().bool, context: r2().func, watchdogConfig: r2().object, config: r2().object, onReady: r2().func, onError: r2().func };
        class u {
          constructor(t3, e3) {
          ...
          _lock() {
            const { _semaphores: t3 } = u, { _state: e3, _element: o3, _lifecycle: r3 } = this, n3 = t3.get(o3) || Promise.resolve(null), a2 = function() {
            ...
            const i2 = n3.then(() => e3.destroyedBeforeInitialization ? Promise.resolve(void 0) : (e3.mountingInProgress = r3.mount().then((t4) => (t4 && this.unsafeSetValue(t4), t4)), e3.mountingInProgress)).then(async (t4) => {
        ...
        class h extends e2().Component {
          constructor(t3) {
            super(t3), this.domContainer = e2().createRef(), this.editorSemaphore = null;
          ...
          shouldComponentUpdate(t3) {
            ...
            return t3.id !== e3.id || (t3.disableWatchdog !== e3.disableWatchdog || (o3 && (o3.runAfterMount(({ instance: o4 }) => {
              ...
              t3.disabled ? e4.enableReadOnlyMode(l) : e4.disableReadOnlyMode(l);
            })), false));
          }
          componentDidMount() {
          ...
          async _initializeEditor() {
            ...
            const t3 = (() => this.context instanceof s.ContextWatchdog ? new p(this.context) : new h._EditorWatchdog(this.props.editor, this.props.watchdogConfig))(), e3 = { current: 0 };
            return t3.setCreator(async (o3, r3) => {
              const { editorSemaphore: n3 } = this, { onAfterDestroy: a2 } = this.props;
              e3.current > 0 && a2 && n3 && n3.value && n3.value.instance && a2(n3.value.instance);
              const i2 = await this._createEditor(o3, r3);
              return e3.current > 0 && (n3.unsafeSetValue({ instance: i2, watchdog: t3 }), setTimeout(() => {
          ...
          _createEditor(t3, e3) {
            return this.props.editor.create(t3, e3).then((t4) => {
              "disabled" in this.props && this.props.disabled && t4.enableReadOnlyMode(l);
          ...
          async _destroyEditor(t3) {
            ...
            return new Promise((t4, r3) => {
              setTimeout(async () => {
                try {
                  if (e3)
                    return await e3.destroy(), t4();
                  if (o3)
                    return await o3.destroy(), t4();
                  t4();
                } catch (t5) {
        ...
        h.contextType = c, h.propTypes = { editor: r2().func.isRequired, data: r2().string, config: r2().object, disableWatchdog: r2().bool, watchdogConfig: r2().object, onChange: r2().func, onReady: r2().func, onFocus: r2().func, onBlur: r2().func, onError: r2().func, disabled: r2().bool, id: r2().any }, h._EditorWatchdog = s.EditorWatchdog;
        class p {
          constructor(t3) {
            this._contextWatchdog = t3, this._id = function() {
              ...
              return "e" + n2[255 & t4] + n2[t4 >> 8 & 255] + n2[t4 >> 16 & 255] + n2[t4 >> 24 & 255] + n2[255 & e3] + n2[e3 >> 8 & 255] + n2[e3 >> 16 & 255] + n2[e3 >> 24 & 255] + n2[255 & o3] + n2[o3 >> 8 & 255] + n2[o3 >> 16 & 255] + n2[o3 >> 24 & 255] + n2[255 & r3] + n2[r3 >> 8 & 255] + n2[r3 >> 16 & 255] + n2[r3 >> 24 & 255];
            }();
          }
          setCreator(t3) {
            this._creator = t3;
        ...
        function g(t3, e3) {
          for (const t4 of Object.getOwnPropertyNames(e3))
            delete e3[t4];
          for (const [o3, r3] of Object.entries(t3))
            r3 !== e3 && "prototype" !== o3 && "__proto__" !== o3 && (e3[o3] = r3);
          return e3;
        }
        const m = (e3) => {
        ...
        }, w = "Lock from React integration (@ckeditor/ckeditor5-react)", _ = (0, t2.memo)((0, t2.forwardRef)(({ id: o3, semaphore: r3, rootName: n3 }, a2) => {
          const i2 = (0, t2.useRef)(null);
          return (0, t2.useEffect)(() => {
            let t3, e3;
            return r3.runAfterMount(({ instance: o4 }) => {
              i2.current && (e3 = o4, t3 = o4.ui.view.createEditable(n3, i2.current), o4.ui.addEditable(t3), o4.editing.view.forceRender());
            }), () => {
              t3 && i2.current && e3 && "destroyed" !== e3.state && e3.ui.removeEditable(t3);
            };
          }, [r3.revision]), e2().createElement("div", { key: r3.revision, id: o3, ref: f(a2, i2) });
        }));
        _.displayName = "EditorEditable";
        const R = (0, t2.forwardRef)(({ editor: o3 }, r3) => {
          ...
          }, [o3 && o3.id]), e2().createElement("div", { ref: f(n3, r3) });
        });
        R.displayName = "EditorToolbarWrapper";
        const C = (o3) => {
          const r3 = (0, t2.useRef)(o3.semaphoreElement || null), n3 = (() => {
            const e3 = (0, t2.useRef)(null), [o4, r4] = (0, t2.useState)(() => Date.now()), n4 = () => {
              r4(Date.now());
            }, a3 = (t3 = true) => {
            ...
            return { get current() {
              ...
              var o5;
              null === (o5 = e3.current) || void 0 === o5 || o5.unsafeSetValue(t3), n4();
            }, release: a3, replace: (t3) => {
              a3(false), e3.current = t3(), n4(), i3(n4);
            }, runAfterMount: i3 };
          })(), a2 = { watchdog: n3.createAttributeRef("watchdog"), instance: n3.createAttributeRef("instance") }, i2 = (0, t2.useContext)(c), [d2, l2] = (0, t2.useState)(() => Object.keys(o3.data)), [h2, f2] = (0, t2.useState)({ ...o3.data }), [C2, v] = (0, t2.useState)({ ...o3.rootsAttributes }), E = (0, t2.useRef)(true);
          (0, t2.useEffect)(() => {
            const t3 = r3.current;
            if (t3 && false !== o3.isLayoutReady)
              return n3.replace(() => new u(t3, { mount: A, afterMount: ({ mountResult: t4 }) => {
                const { onReady: e3 } = o3;
                e3 && null !== r3.current && e3(t4.instance);
              }, unmount: async ({ element: t4, mountResult: e3 }) => {
                const { onAfterDestroy: r4 } = o3;
                try {
                  await O(e3), t4.innerHTML = "";
                } finally {
                  r4 && r4(e3.instance);
                }
              } })), () => {
          ...
          const x = () => {
            const t3 = o3.config || {};
            return o3.data && t3.initialData && console.warn("Editor data should be provided either using `config.initialData` or `data` property. The config value takes precedence over `data` property and will be used when both are specified."), { ...t3, rootsAttributes: C2 };
          }, k = m((t3, e3) => {
            ...
            if (!o3.disableTwoWayDataBinding) {
              ...
              r4.differ.getChanges().forEach((o5) => {
                let r5;
                if (r5 = "insert" == o5.type || "remove" == o5.type ? o5.position.root : o5.range.root, !r5.isAttached())
                  return;
                const { rootName: n4 } = r5;
                e4[n4] = t3.getData({ rootName: n4 });
              }), r4.differ.getChangedRoots().forEach((r5) => {
                if (r5.state)
                  return void (void 0 !== e4[r5.name] && delete e4[r5.name]);
                const n4 = r5.name;
                o4[n4] = t3.getRootAttributes(n4);
              }), Object.keys(e4).length && f2((t4) => ({ ...t4, ...e4 })), Object.keys(o4).length && v((t4) => ({ ...t4, ...o4 }));
            }
            o3.onChange && o3.onChange(e3, t3);
          }), W = m((t3, e3, r4) => {
            const n4 = r4.rootName;
            o3.disableTwoWayDataBinding || (f2((e4) => ({ ...e4, [n4]: t3.getData({ rootName: n4 }) })), v((e4) => ({ ...e4, [n4]: t3.getRootAttributes(n4) }))), l2((t4) => {
              return e4 = [...t4, r4.rootName], Array.from(new Set(e4));
              var e4;
            });
          }), S = m((t3, e3, r4) => {
            const n4 = r4.rootName;
            o3.disableTwoWayDataBinding || (f2((t4) => {
              const { [n4]: e4, ...o4 } = t4;
              return { ...o4 };
            }), v((t4) => {
              const { [n4]: e4, ...o4 } = t4;
              return { ...o4 };
            })), l2((t4) => t4.filter((t5) => t5 !== n4));
          }), M = m((t3, e3) => (g({ ...o3.rootsAttributes }, C2), g({ ...o3.data }, h2), y(Object.keys(o3.data), d2), o3.editor.create(t3, e3).then((t4) => {
            const e4 = t4.getFullData();
            g({ ...e4 }, h2), g({ ...t4.getRootsAttributes() }, C2), y(Object.keys(e4), d2), o3.disabled && t4.enableReadOnlyMode(w);
            const r4 = t4.model.document, n4 = t4.editing.view.document;
            return r4.on("change:data", (e5) => k(t4, e5)), t4.on("addRoot", (e5, o4) => W(t4, e5, o4)), t4.on("detachRoot", (e5, o4) => S(t4, e5, o4)), n4.on("focus", (e5) => {
            ...
            if (o3.disableWatchdog) {
              return { instance: await M(o3.data, x()), watchdog: null };
            }
            const t3 = i2 instanceof s.ContextWatchdog ? new p(i2) : new s.EditorWatchdog(o3.editor, o3.watchdogConfig), e3 = { current: 0 };
            return t3.setCreator(async (r4, i3) => {
              const { onAfterDestroy: s2 } = o3;
              e3.current > 0 && s2 && a2.instance.current && s2(a2.instance.current);
              const c2 = await M(r4, i3);
              return e3.current > 0 && (n3.unsafeSetValue({ instance: c2, watchdog: t3 }), setTimeout(() => {
            ...
            }), await t3.create(h2, x()).catch((t4) => {
              throw (o3.onError || console.error)(t4, { phase: "initialization", willEditorRestart: false }), t4;
            }), { watchdog: t3, instance: t3.editor };
          }, D = (0, t2.useCallback)((t3) => {
            n3.runAfterMount(() => {
              E.current = true, f2(t3);
            });
          }, [f2]), j = (0, t2.useCallback)((t3) => {
            n3.runAfterMount(() => {
              E.current = true, v(t3);
            });
          }, [v]), T = e2().createElement(R, { ref: r3, editor: a2.instance.current });
          b(n3.current, ({ instance: t3 }) => {
            o3.disabled ? t3.enableReadOnlyMode(w) : t3.disableReadOnlyMode(w);
          }, [o3.disabled]), b(n3.current, ({ instance: t3 }) => {
            if (E.current) {
              E.current = false;
              const e3 = Object.keys(h2), o4 = Object.keys(C2);
              if (!e3.every((t4) => o4.includes(t4)))
                throw console.error("`data` and `attributes` objects must have the same keys (roots)."), new Error("`data` and `attributes` objects must have the same keys (roots).");
              const r4 = t3.getFullData(), n4 = t3.getRootsAttributes(), { addedKeys: a3, removedKeys: i3 } = ((t4, e4) => {
              ...
              })(r4, h2 || {}), s2 = e3.some((t4) => void 0 !== r4[t4] && JSON.stringify(r4[t4]) !== JSON.stringify(h2[t4])), c2 = o4.filter((t4) => JSON.stringify(n4[t4]) !== JSON.stringify(C2[t4])), d3 = (e4) => {
                e4.forEach((e5) => {
                  t3.addRoot(e5, { data: h2[e5] || "", attributes: (null == C2 ? void 0 : C2[e5]) || {}, isUndoable: true });
                });
              }, u2 = (e4) => {
                e4.forEach((e5) => {
                ...
                t3.data.set(h2, { suppressErrorInCollaboration: true });
              }, p2 = (e4, o5) => {
                o5.forEach((o6) => {
                  Object.keys(C2[o6]).forEach((e5) => {
                    t3.registerRootAttribute(e5);
                  }), e4.clearAttributes(t3.model.document.getRoot(o6)), e4.setAttributes(C2[o6], t3.model.document.getRoot(o6));
                });
              };
              setTimeout(() => {
                t3.model.change((t4) => {
                  d3(a3), u2(i3), s2 && l3(), c2.length && p2(t4, c2);
                });
              });
            }
          }, [h2, C2]);
          const L = d2.map((t3) => e2().createElement(_, { key: t3, id: t3, rootName: t3, semaphore: n3 }));
          return { editor: a2.instance.current, editableElements: L, toolbarElement: T, data: h2, setData: D, attributes: C2, setAttributes: j };
        };
      })(), i;
    })());
  }
